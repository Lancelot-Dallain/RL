...
#%% Hyperparamètres
MEM_SIZE = 409                   # Taille de la mémoire du buffer Replay (4096)
...
FC1_DIMS=16                        # Nombre neurones premiere couche cachée
FC2_DIMS=16                        # Nombre neurones deuxième couche cachée
lr=0.0001                          # learning rate
exploration_decreasing_decay=7     # vitesse de décroissance mode exploration (7)
gamma=0.5                    # pondération cumulated reward (0.95)
#%%
